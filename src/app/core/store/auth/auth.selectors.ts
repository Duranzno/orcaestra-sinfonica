...
export const getGroup = createSelector(getAuthState, (state: State) => state.user.grupo);
export const getUid = createSelector(getAuthState, (state: State) => state.user.uid);
